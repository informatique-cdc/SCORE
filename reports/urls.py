...
urlpatterns = [
    ...
    path("<uuid:job_pk>/contradictions.csv", views.export_contradictions_csv, name="export-contradictions-csv"),
    path("<uuid:job_pk>/gaps.csv", views.export_gaps_csv, name="export-gaps-csv"),
    path("<uuid:job_pk>/hallucinations.csv", views.export_hallucinations_csv, name="export-hallucinations-csv"),
