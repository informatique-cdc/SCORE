...
urlpatterns = [
    ...
    path("<uuid:pk>/contradictions/<uuid:contra_pk>/resolve/", views.contradiction_resolve, name="contradiction-resolve"),
    path("<uuid:pk>/contradictions/batch-resolve/", views.contradiction_batch_resolve, name="contradiction-batch-resolve"),
    ...
    path("<uuid:pk>/hallucinations/<uuid:hallu_pk>/resolve/", views.hallucination_resolve, name="hallucination-resolve"),
    path("<uuid:pk>/hallucinations/batch-resolve/", views.hallucination_batch_resolve, name="hallucination-batch-resolve"),
    ...
    path("<uuid:pk>/_progress_full/", views.analysis_progress_full_partial, name="analysis-progress-full-partial"),
    ...
    path("<uuid:pk>/api/concept-graph/query/", views.concept_graph_query, name="api-concept-graph-query"),
    # Audit RAG routes
    ...
    path("audit/<uuid:pk>/retrievability/", views_audit.audit_retrievability, name="audit-retrievability"),
    path("audit/<uuid:pk>/governance/", views_audit.audit_governance, name="audit-governance"),
    path("audit/<uuid:pk>/_progress/", views_audit.audit_progress_partial, name="audit-progress-partial"),
